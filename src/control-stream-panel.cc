...
Control_stream_panel::Control_stream_panel(App_control *app_control,
                                           QWidget *parent)
  : QGroupBox(tr("Stream &Control"), parent)
{
  if (!app_control) {
    Log::fatal("Control_stream_panel::Control_stream_panel(): "
               "app_control is NULL");
  }
...
Control_stream_panel::~Control_stream_panel()
{
...
void
Control_stream_panel::create_actions()
{
  connect(_button_start, &QPushButton::released,
          this, &Control_stream_panel::start_stream);
  connect(_button_stop, &QPushButton::released,
          this, &Control_stream_panel::stop_stream);
}

void
Control_stream_panel::start_stream()
{
  _app_control->start_stream();
}

void
Control_stream_panel::stop_stream()
{
  _app_control->stop_stream();
}

void
Control_stream_panel::stream_started()
{
...
void
Control_stream_panel::stream_stopped()
{
  _button_start->setEnabled(true);
  _button_stop->setEnabled(false);
}
