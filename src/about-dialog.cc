...
About_dialog::About_dialog(QWidget *parent) : QDialog(parent)
{
  ...
  if (!_app_icon->load("app-icon.png")) {
    Log::warn("About_dialog::About_dialog(): failed loading application icon");
  }
...
About_dialog::~About_dialog()
{
  ...
  delete _app_icon;
  _app_icon = 0;
  _about_text->deleteLater();
  _about_text = 0;
  _about_document->deleteLater();
  _about_document = 0;
  _button_box->deleteLater();
  _button_box = 0;
}
