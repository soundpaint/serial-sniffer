...
#ifndef LOG_PANEL_LIST_UPDATER_HH
...
class Log_panel_list_updater :
  public QTimer,
  public ISerial_event_listener
{
  Q_OBJECT
public:
  explicit Log_panel_list_updater(QObject *parent,
                                  Log_panel_list *log_panel_list);
  virtual ~Log_panel_list_updater();
  virtual void log_clear();
